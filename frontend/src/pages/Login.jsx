...
function Login() {
  return (
    <div className="min-h-screen bg-paper grid lg:grid-cols-[1.1fr_1fr]">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-night text-white p-14 relative overflow-hidden">
        ...
        <div className="max-w-xl">
          ...
          <h1 className="font-display font-extrabold text-[3.5rem] xl:text-[4.25rem] leading-[0.95] tracking-[-0.035em] text-white">
            University
            <br />
            Management
            <br />
